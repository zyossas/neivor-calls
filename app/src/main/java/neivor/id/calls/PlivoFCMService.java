...
public class PlivoFCMService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData() != null) {
            ...
            if (((NeivorCallsAplication) getApplication()).backend().loginForIncoming(deviceToken)) {
                ((NeivorCallsAplication) getApplication()).backend().relayIncomingPushData(new HashMap<>(remoteMessage.getData()));
            }
    ...
    public void notificationDialog() {
        ...
        Intent launchIntent = new Intent(this, CallerActivity.class);
